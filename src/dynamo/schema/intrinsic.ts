...
import type {AtLeast1, Attr, Both, Elem, One} from '#disreact/dsx/intrinsic-elements/helpers.ts';
...
export interface Intrinsic extends SpecialFormat, ListElement, DFMarkdown, Input {
