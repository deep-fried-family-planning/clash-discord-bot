...
import {dtRel} from '#src/internal/old/markdown.ts';
 ...
 */
export const remind_me = (ix: Discord.APIInteraction, ops: IxDS<typeof REMIND_ME>) => E.gen(function* () {
