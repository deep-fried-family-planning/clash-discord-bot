...
import type {makeParams} from '#src/internal/ix-system/id/params.ts';
import type {makeView} from '#src/internal/ix-system/store/make-view.ts';
import type {createComponent} from '#src/internal/ix-system/store/make-component.ts';
import {type makeSlice, slicePredicate} from '#src/internal/ix-system/store/make-slice.ts';
