import type * as Declarations from '#src/internal/a/codec/old/declarations.ts';
import type * as FC from '#src/internal/a/codec/fc.ts';
import type {Relay} from '#src/internal/a/adaptor/Relay.ts';
