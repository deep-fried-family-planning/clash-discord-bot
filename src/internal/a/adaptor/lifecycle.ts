...
import * as Diff from '#src/internal/a/codec/old/diffs.ts';
import * as Component from '#src/internal/a/adaptor/component.ts';
import * as Element from '#src/internal/a/adaptor/element.ts';
import * as Polymer from '#disreact/core/internal/polymer.ts';
import * as Rehydrant from '#src/internal/a/adaptor/envelope.ts';
import {Relay} from '#src/internal/a/adaptor/Relay.ts';
import * as Mutex from '#src/internal/a/adaptor/mutex.ts';
import * as Progress from '#src/internal/a/codec/old/progress2.ts';
