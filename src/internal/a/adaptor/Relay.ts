import type {Envelope} from '#src/internal/a/adaptor/envelope.ts';
import type {EventDefect, RenderDefect, UpdateDefect} from '#src/internal/a/adaptor/lifecycle.ts';
import type {SourceDefect} from '#src/internal/a/adaptor/Rehydrator.ts';
