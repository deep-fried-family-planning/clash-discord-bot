import type * as Element from '#src/internal/a/adaptor/element.ts';
import type * as Rehydrant from '#src/internal/a/adaptor/envelope.ts';
import * as current from '#src/internal/a/adaptor/global.ts';
