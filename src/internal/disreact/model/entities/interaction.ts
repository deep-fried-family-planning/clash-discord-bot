...
import {Auth, Err} from '#src/internal/disreact/entity/index.ts';
import {Cm, Co, DA, Df, Em, Ev} from '#src/internal/disreact/model/entities/index.ts';
import {ComponentRoute, DialogRoute, MainRoute} from '#src/internal/disreact/model/route/index.ts';
...
export const decodeInteraction = (rest: DA.Ix) => g(function * () {
  ...
  yield * E.logDebug('custom_id', rest.data.custom_id);
