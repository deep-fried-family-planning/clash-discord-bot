...
export const makeIgnore        = (id: str) => Ignore({id});
export const makeDefault       = (id: str) => Default({id});
export const makeRestComponent = (id: str) => RestComponent({id});
export const makeRestEmbed     = (id: str) => RestEmbed({id});
export const makeDialogLinked  = (id: str) => DialogLinked({id});
