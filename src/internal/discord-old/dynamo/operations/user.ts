import {encodeUserId} from '#src/internal/discord-old/dynamo/schema/common-encoding.ts';
import {decodeDiscordUser, type DUser, encodeDiscordUser} from '#src/internal/discord-old/dynamo/schema/discord-user.ts';
