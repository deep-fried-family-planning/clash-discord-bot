import {encodeEmbedId} from '#src/internal/discord-old/dynamo/schema/common-encoding.ts';
import {decodeDiscordEmbed, type DEmbed, type DEmbedKey, encodeDiscordEmbed} from '#src/internal/discord-old/dynamo/schema/discord-embed.ts';
