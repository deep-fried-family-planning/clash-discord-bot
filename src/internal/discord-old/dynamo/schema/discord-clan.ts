...
import {encodeClanTag, encodeServerId} from '#src/internal/discord-old/dynamo/schema/common-encoding.ts';
import {ClanTag, EmbedId, ServerId, ThreadId} from '#src/internal/discord-old/dynamo/schema/common.ts';
