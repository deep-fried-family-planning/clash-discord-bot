import type {Envelope} from '#src/disreact/model/internal/adaptor/exp/domain/old/envelope.ts';
import type {EventDefect, RenderDefect, UpdateDefect} from '#src/disreact/model/internal/adaptor/exp/v1lifecycle.ts';
import type {SourceDefect} from '#src/disreact/model/internal/adaptor/exp/Rehydrator.ts';
