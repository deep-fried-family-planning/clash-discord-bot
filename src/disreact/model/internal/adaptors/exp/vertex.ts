...
import * as Precursor from '#src/disreact/model/internal/adaptors/exp/precursor.ts';
import type * as Valence from '#src/disreact/model/internal/adaptors/exp/valence.ts';
