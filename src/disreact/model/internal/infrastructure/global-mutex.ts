...
export type GlobalMutex = never;

export const mutex = GlobalValue.globalValue(
...
export const acquire = (rh: Rehydrant.Envelope, n: Element.Comp) =>
  lock.pipe(
    E.andThen(
...
export const release = <A, E, R>(rh: Rehydrant.Envelope, n: Element.Comp) => (effect: E.Effect<R, E, A>) =>
  effect.pipe(
    E.tap(reset),
