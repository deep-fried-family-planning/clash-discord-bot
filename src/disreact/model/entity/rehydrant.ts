...
export const rehydrate = (src: Source, hydrator: Hydrator, data: any): Rehydrant => {
  const cloned = El.createRoot(src.el.type, hydrator.props);
...
export const notify = (rh: Rehydrant, node: El.Comp) => {
