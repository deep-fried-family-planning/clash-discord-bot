...
import type * as Jsx from '#disreact/model/runtime/JsxRuntime.tsx';
...
export const normalizePropsFC = (fc: FC, props: any): E.Effect<Jsx.Children> => {
  switch (fc._tag) {
    case 'Sync': {
...
export const normalizeEventHandler = (fn: EventFn, event: any): E.Effect<void> => {
