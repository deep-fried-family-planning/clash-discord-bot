import type {Envelope} from '#src/disreact/codec/adaptor/exp/domain/old/envelope.ts';
import type {EventDefect, RenderDefect, UpdateDefect} from '#src/disreact/codec/adaptor/exp/v1lifecycle.ts';
import type {SourceDefect} from '#src/disreact/codec/adaptor/exp/Rehydrator.ts';
