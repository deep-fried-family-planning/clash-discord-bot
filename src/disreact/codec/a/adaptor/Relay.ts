...
import type {EventDefect, RenderDefect, UpdateDefect} from '#disreact/codec/a/adaptor/lifecycle.ts';
import type {SourceDefect} from '#disreact/codec/a/adaptor/Rehydrator.ts';
