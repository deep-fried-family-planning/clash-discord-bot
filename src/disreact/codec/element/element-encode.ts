...
export const encodeMessageDsx = (node: Element.Element): EncodedMessage => {
...
export const encodeDialogDsx = (node: Element.Element): EncodedDialog => {
...
export const encodeDsx = (node: Element.Element): EncodedRoot[] => {
