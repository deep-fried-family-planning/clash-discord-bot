...
import type * as El from '#src/disreact/model/internal/core/element.ts';
...
const upstream = GlobalValue
  .globalValue(Symbol.for('disreact/deps'), () => new WeakMap<El.Comp | Rehydrant.Envelope, Set<El.Comp>>());
