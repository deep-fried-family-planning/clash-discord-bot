...
import {declareHandler, declareHandlerElem, declareProps} from '#src/disreact/codec/dapi-elem/util.ts';
import type {Elem} from '#src/disreact/model/elem/elem.ts';
import {S} from '#src/disreact/utils/re-exports.ts';
import {DAPI} from '../../dapi/dapi';

export * as Roles from '#src/disreact/codec/dapi-elem/component/roles.ts';
