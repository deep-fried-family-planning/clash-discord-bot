import {NONE_STR, Rest} from '#src/disreact/codec/abstract/index.ts';
import type {EncodedDialog, EncodedMessage} from '#src/disreact/codec/dsx-encoder.ts';
import {makeRoute} from '#src/disreact/codec/utils.ts';
