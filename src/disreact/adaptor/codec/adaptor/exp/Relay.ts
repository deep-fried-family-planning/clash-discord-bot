...
import type {EventDefect, RenderDefect, UpdateDefect} from '#src/disreact/adaptor/codec/adaptor/exp/v1lifecycle.ts';
import type {SourceDefect} from '#src/disreact/adaptor/codec/adaptor/exp/Rehydrator.ts';
