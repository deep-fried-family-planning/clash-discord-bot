...
import type {EventDefect, RenderDefect, UpdateDefect} from '#src/disreact/adaptor/adaptor/lifecycle.ts';
import type {SourceDefect} from '#src/disreact/adaptor/adaptor/Rehydrator.ts';
