...
import type * as Polymer from '#disreact/model/internal/core/internal/polymer.ts';
import type * as Stack from '#disreact/model/internal/core/behaviors/exp/Stack.ts';
