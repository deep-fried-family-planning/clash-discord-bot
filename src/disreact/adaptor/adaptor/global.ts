...
import type * as Document from '#disreact/model/core/behaviors/exp/documentold.ts';
import type * as Polymer from '#disreact/model/core/internal/polymer.ts';
import type * as Stack from '#disreact/model/core/behaviors/exp/Stack.ts';
import type * as Node from '#disreact/model/core/behaviors/exp/nodev1.ts';
