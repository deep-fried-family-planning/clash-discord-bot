import {proto} from '#disreact/model/internal/core/behaviors/proto.ts';
import * as Element from '#src/disreact/adaptor/adaptor/element.ts';
import * as FC from '#disreact/model/internal/core/internal/fn.ts';
import type * as Rehydrant from '#src/disreact/adaptor/adaptor/envelope.ts';
import * as Polymer from '#disreact/model/internal/core/internal/polymer.ts';
