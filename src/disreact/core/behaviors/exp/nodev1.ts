import type * as Diffable from '#disreact/core/behaviors/diffable.ts';
...
import {FRAGMENT, FUNCTIONAL, INTRINSIC, IS_DEV, TEXT_NODE} from '#disreact/core/immutable/constants.ts';
