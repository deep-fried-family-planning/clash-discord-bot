...
import * as Diff from '#disreact/core/a/codec/old/diffs.ts';
import * as Component from '#disreact/core/a/adaptor/component.ts';
import * as Element from '#disreact/core/a/adaptor/element.ts';
import * as Polymer from '#disreact/core/internal/polymer.ts';
import * as Rehydrant from '#disreact/core/a/adaptor/envelope.ts';
import {Relay} from '#disreact/core/a/adaptor/Relay.ts';
import * as Mutex from '#disreact/core/a/adaptor/mutex.ts';
