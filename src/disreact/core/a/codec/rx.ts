...
import * as Container from '#disreact/core/a/intrinsic/container.ts';
import * as Params from '#disreact/core/a/codec/params.ts';
import * as Declarations from '#disreact/core/a/codec/old/declarations.ts';
import {hole as forbidden, pipe} from 'effect/Function';
import * as S from 'effect/Schema';

export * as Rx from '#disreact/core/a/codec/rx.ts';
