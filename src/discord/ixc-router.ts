...
import {v2_driver} from '#src/internal/ix-system/model/v2/v2.ts';
import {Discord, UI} from 'dfx';
import type {TxCx} from '#src/internal/ix-system/store/make-component.ts';

import {COLOR, nColor} from '#src/constants/colors.ts';
import {CxId} from '#src/internal/ix-system/id/cx-id.ts';
import {RK_ENTRY} from '#src/constants/route-kind.ts';
import {runner} from '#src/internal/ix-system/model/runner.ts';
import {v3_driver} from '#src/internal/ix-system/model/v3/v3.ts';
...
const router = (ix: IxD) => E.gen(function * () {
    ...
    yield * CSL.debug(`driver found: ${driver.name}`);
